...
## 🛠 Step 1: Start Fresh (Delete Old Files & Repo)  
### **1.1 Delete Local Hugo Project**  
```sh
rm -rf ~/my-doc-website
ls ~/

1.2 Delete GitHub Repository
Go to GitHub.com → Log in
Navigate to Repositories → Find my-doc-website
Click Settings → Scroll down to Delete this repository
Confirm deletion
